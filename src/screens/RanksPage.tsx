        ...
        <View
          style={[
            styles.rankCard,
            {
              ...
              borderColor: isDark ? withAlpha(tierColor, 0.35) : withAlpha(tierColor, 0.22),
              shadowColor: isDark ? tierColor : '#6B3E12',
            },
          ]}
        >
...
const styles = StyleSheet.create({
  ...
  /* Soft orange segmented control — no hard neubrutalist shadow */
  segmented: {
    flexDirection: 'row',
    padding: 4,
    borderRadius: 999,
  ...
  segmentActive: { backgroundColor: AppColors.primary, shadowColor: '#C2410C', shadowOpacity: 0.35, shadowRadius: 18, shadowOffset: { width: 0, height: 3 }, elevation: 4 },
  segmentText: { fontSize: 13, fontFamily: fontFamilyFor('w800'), lineHeight: 16, letterSpacing: 0.1 },

  rankCard: {
    borderRadius: 28,
    borderWidth: 1.5,
    borderColor: 'rgba(107,62,18,0.10)',
